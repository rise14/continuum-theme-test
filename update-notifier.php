...
define( 'NOTIFIER_THEME_NAME', 'Continuum' ); // The theme name
define( 'NOTIFIER_THEME_FOLDER_NAME', 'continuum' ); // The theme folder name
define( 'NOTIFIER_XML_FILE', 'http://www.brianmcculloh.com/updates/continuum/notifier.xml' ); // The remote notifier XML file containing the latest version of the theme and changelog
define( 'NOTIFIER_CACHE_INTERVAL', 0 ); // The time interval for the remote XML cache in the database (21600 seconds = 6 hours)
